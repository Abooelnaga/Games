...
function display_intro_instructions() {
  ...
  ctx.fillText(
    'اضغط أو المس أو انقر لبدء اللعبة',
    myCanvas.width / 2,
    myCanvas.height / 4
  );
}
function display_game_over() {
  ...
  ctx.font = '30px Tajawal'; // تغيير الخط إلى Tajawal
  ctx.fillStyle = 'red';
  ctx.textAlign = 'center';
  ctx.fillText('انتهت اللعبة', myCanvas.width / 2, 100);
  ctx.fillText('النقاط: ' + score, myCanvas.width / 2, 150);
  ctx.font = '20px Tajawal';
  ctx.fillText('اضغط، المس، أو انقر للعب مرة أخرى', myCanvas.width / 2, 300);
}
