...
function win() {
  ...
  if (s % 60 < 10) {
    stats.textContent = "لقد فزت بـ: " + stars + " نجوم في " + movesCounter + " حركات خلال وقت: " + m + ":0" + s % 60;
  } else {
    stats.textContent = "لقد فزت بـ: " + stars + " نجوم في " + movesCounter + " حركات خلال وقت: " + m + ":" + s % 60;
  }
}

function updateMoveCounter() {
  movesCounter++;
  moves.textContent = "الحركات: " + movesCounter;
  if (movesCounter === 13) {
...
function timer() {
  ...
  if (s % 60 < 10) {
    timer.textContent = "الوقت المنقضي: " + m + ":0" + s % 60;
  } else {
    timer.textContent = "الوقت المنقضي: " + m + ":" + s % 60;
  }
}
...
function restartGame() {
  ...
  let timer = document.querySelector(".timer");
  timer.textContent = "الوقت المنقضي: 0:00";
  moves.textContent = "الحركات: " + movesCounter;
