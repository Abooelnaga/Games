  ...
  if (
    ...
    lanes[currentLane].vechicles.forEach((vechicle) => {
      ...
      if (chickenMaxX > carMinX && chickenMinX < carMaxX) {
        ...
        // Add this line to clear all pending moves when collision happens
        moves = [];
        // Add this to prevent new moves after collision
        startMoving = false;
      }
    });
  }
...
// Modify the move function to check if game is over before allowing movement
function move(direction) {
  // Add this check to prevent movement when end screen is visible
