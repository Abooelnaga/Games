...
FlappyMonster.prototype.drawInitialScreen = function () {
    ...
    game.context.font = "36px Tajawal";
    game.context.fillText("اضغط للبدء!", game.canvas.width / 2 - 100, game.canvas.height / 2);
}
...
FlappyMonster.prototype.drawGameOverScreen = function () {
    ...
    game.context.font = "54px Tajawal";
    game.context.fillText(game.gameScore.score + " : النتيجة", game.canvas.width / 2, game.canvas.height / 2 - 100);

    game.context.font = "36px Tajawal";
    game.context.fillText("انتهت اللعبة", game.canvas.width / 2, game.canvas.height / 2);

    game.context.font = "24px Tajawal";
    game.context.fillText("اضغط R لإعادة اللعب!", game.canvas.width / 2, game.canvas.height / 2 + 50);
}
...
FlappyMonster.prototype.drawInitialScreen = function () {
    ...
    game.context.textAlign = "center";
    game.context.font = "36px Tajawal";
    game.context.fillText("اضغط للبدء!", game.canvas.width / 2, game.canvas.height / 2);
}